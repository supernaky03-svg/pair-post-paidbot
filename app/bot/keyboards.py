...
def main_menu(language: str) -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text=t(language, "menu_help")), KeyboardButton(text=t(language, "menu_add_pair")), KeyboardButton(text=t(language, "menu_delete_pair"))],
            [KeyboardButton(text=t(language, "menu_edit_source")), KeyboardButton(text=t(language, "menu_edit_target")), KeyboardButton(text=t(language, "menu_keyword"))],
            [KeyboardButton(text=t(language, "menu_ads")), KeyboardButton(text=t(language, "menu_status")), KeyboardButton(text=t(language, "menu_check"))],
            [KeyboardButton(text=t(language, "menu_forward_rule")), KeyboardButton(text=t(language, "menu_post_rule")), KeyboardButton(text=t(language, "menu_language"))],
            [KeyboardButton(text=t(language, "menu_contact")), KeyboardButton(text=t(language, "menu_back")), KeyboardButton(text=t(language, "menu_cancel"))],
        ],
...
def keyword_action_keyboard(language: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text=t(language, "menu_back"), callback_data="kw_action:back"), InlineKeyboardButton(text=t(language, "menu_cancel"), callback_data="kw_action:cancel")],
        ]
    )
...
def ads_action_keyboard(language: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text=t(language, "menu_back"), callback_data="ads_action:back"), InlineKeyboardButton(text=t(language, "menu_cancel"), callback_data="ads_action:cancel")],
        ]
    )

def pair_picker(prefix: str, pairs: list[PairRecord], language: str, *, include_all: bool = False) -> InlineKeyboardMarkup:
    rows = [[InlineKeyboardButton(text=f"#{pair.pair_no}", callback_data=f"{prefix}:{pair.pair_no}")] for pair in pairs]
    if include_all:
