...
MIGRATIONS = [
    ...
    CREATE TABLE IF NOT EXISTS pairs (
        ...
        remove_url_rule BOOLEAN NOT NULL DEFAULT TRUE,
        ...
        ads_mode TEXT NOT NULL DEFAULT 'all',
        video_post_remove BOOLEAN NOT NULL DEFAULT FALSE,
        remove_text_values JSONB NOT NULL DEFAULT '[]'::jsonb,
    ...
    "ALTER TABLE pairs ADD COLUMN IF NOT EXISTS remove_text_values JSONB NOT NULL DEFAULT '[]'::jsonb",
    """
    UPDATE pairs
    SET ads_mode = 'all'
    WHERE ads_mode IS NULL OR ads_mode NOT IN ('all', 'video_only', 'non_video_only')
    """,
    """
